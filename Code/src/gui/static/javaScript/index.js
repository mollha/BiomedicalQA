document.addEventListener("DOMContentLoaded", function(){
	...
	const factoid_examples = [
		...
		// ["What particles is Hadron therapy using?", "The use of hadron beams, especially proton beams, in cancer radiotherapy has expanded rapidly in the past two decades. ", ["Proton beams"]],
		...
		// ["Which was the first genetically modified organism (GMO) to be used as vaccine?", "The oral live cholera vaccine CVD 103-HgR (Orochol, Mutachol), the first genetically modified organism (GMO) used as vaccine, was in its time (launched 1993, Switzerland) the ideal cholera vaccine: single-dose, protective efficacy of 80-100% against moderate to severe cholera, acting within 8 days and exhibiting excellent safety, indiscernible from placebo.", ["Vaxchora", "CVD 103-HgR"]],
		// ["Which T-UCR has been implicated in prostate cancer?", "Transcribed ultraconserved region Uc.63+ promotes resistance to docetaxel through regulation of androgen receptor signaling in prostate cancer.", ["Uc.63+"]],
	...
	const list_examples = [
		...
		// ["List symptoms of the One-and-a-half syndrome.", "One-and-a-half syndrome is defined by conjugated horizontal gaze palsy and internuclear ophthalmoplegia", ["conjugated horizontal gaze palsy", "internuclear ophthalmoplegia"]],
		// ["List characteristic features of the Revesz syndrome.", "PURPOSES: To inform about a case of Revesz syndrome (RS) with initial ophthalmological symptomatology of severe proliferative vitreoretinopathy of the left eye (LE). After the aplastic anemia had developed, RS was established. In preoperative screening,\u00a0thrombocytopenia was detected; later, severe pancytopenia developed. Considering the hematological findings and clinical appearance, we suspected RS, which was confirmed by genetic tests. CONCLUSIONS: RS is an extremely rare condition.\u00a0 The initial symptomatology could be ophthalmological or hematological.", ["aplastic anemia", "retinopathy", "nail dystrophy", "cerebellar hypoplasia"]],
